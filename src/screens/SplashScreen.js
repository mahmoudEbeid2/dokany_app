...
const styles = StyleSheet.create({
  ...
  title: { fontSize: theme.fonts.size.xxl, fontFamily: theme.fonts.bold, color: theme.colors.primary, letterSpacing: 2, fontWeight: 'bold', marginBottom: 8 },
  tagline: { fontSize: theme.fonts.size.md, color: theme.colors.textSecondary, fontFamily: theme.fonts.regular, marginTop: 2 },
  ...
  titleStrong: { fontSize: 44, fontFamily: theme.fonts.bold, color: '#fff', letterSpacing: 6, fontWeight: 'bold', marginBottom: 16, textShadowColor: 'rgba(0,0,0,0.25)', textShadowOffset: {width: 0, height: 4}, textShadowRadius: 12, textAlign: 'center' },
  taglineStrong: { fontSize: theme.fonts.size.md, color: 'rgba(255,255,255,0.7)', fontFamily: theme.fonts.regular, marginTop: 24, letterSpacing: 1, fontStyle: 'italic', fontWeight: '300', textAlign: 'center' },
});
